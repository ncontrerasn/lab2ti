...
%vector que contendrá la señal codificada para luego graficar los 6 tipos de señal
bit = [];
...
for i = 1 : length(q)
  if (last != q(i))
    ...
    #concatenar todas las señales codificadas obtenidas
    for j = 1 : length(str) 
...
#devolvemos el arreglo llmadao bit con las señales codificadas y xq con las señales cuantizadas
